...
SUITES=${1:-"prompts build ferry export geo library safety scope photos cloud shop mapview quests i18n-parity dom media places gmap terrain contrast sweep nav"}
FAILED=0
for s in $SUITES; do
  echo ""
  echo "=============== $s ==============="
