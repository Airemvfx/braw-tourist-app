...
const EN = {
  ...
  'data.exported': 'Saved {trips} quests and {photos} photographs.',
  ...
  'data.truncated': 'That file holds the small copies only — there were too many full-size photographs to fit in one. Use “Save every photo to my device” for the originals.',
  'data.photosDropped': '{n} photographs could not be restored — this device is out of room.',
  'data.warnCloud': 'Clearing your browser data erases anything not yet uploaded to your account.',
  'nav.store': 'Store',
  ...
  'auth.confirmSent': 'Check your email and click the link to finish creating your account.',
  'auth.willCarryOver': 'Your current progress will move to the new account.',
  'auth.noteCloud': 'Your account works on any device you sign in on. Photographs stay on your device unless you upload them.',
  'auth.err.needEmail': 'Enter your email address first.',
  'photo.upload': 'Upload a copy',
  'photo.uploaded': 'Copied to your account',
  'photo.removeConfirm': 'Delete this photograph? If there is no copy elsewhere, it is gone for good.',
  'photo.failedSpace': 'There is no room left on this device for another photograph.',

  // ---- your photographs: where they live and how to keep them ----
  'vault.title': 'Your photographs',
  'vault.checking': 'Checking where your photographs are kept…',
  'vault.none': 'No photographs yet. Take one at a stop and it is kept on this device.',
  'vault.durability.persisted': 'This browser has agreed to keep them, and will not clear them to free up space.',
  'vault.durability.besteffort': 'Kept on this device — but the browser may clear them if it runs short of space.',
  'vault.durability.denied': 'The browser would not promise to keep them, so they may be cleared if space runs short.',
  'vault.durability.none': 'This browser cannot promise to keep them.',
  'vault.usage': '{used} of {total} used ({pct}%)',
  'vault.copiedAll': 'All {n} have a second copy in your account.',
  'vault.copiedSome': '{n} of {total} have a second copy in your account.',
  'vault.ios': 'On iPhone and iPad a site left unopened for a while can be cleared. Adding BRAW to your Home Screen stops that.',
  'vault.risk.empty': 'Nothing to lose yet.',
  'vault.risk.safe': 'Safe — every photograph exists in more than one place.',
  'vault.risk.ok': 'Kept on this device.',
  'vault.risk.medium': 'These live on this device only. Worth keeping a copy elsewhere.',
  'vault.risk.high': 'At risk — these exist only here, and could be cleared without warning.',
  'vault.saveFiles': 'Save every photo to my device',
  'vault.protect': 'Ask the browser to keep them',
  'vault.uploadAll': 'Upload {n} to my account',
  'vault.note': 'Clearing your browser data deletes photographs kept only here. A saved copy, or an upload, is the only thing that survives it.',
  'vault.saving': 'Saving {done} of {total}…',
  'vault.saved': 'Saved {n} photographs.',
  'vault.cancelled': 'Nothing was saved.',
  'vault.saveFailed': 'The photographs could not be saved.',
  'vault.protected': 'The browser will keep your photographs.',
  'vault.protectRefused': 'The browser would not promise yet. Use BRAW a few more times, or add it to your Home Screen, and ask again.',
  'vault.uploading': 'Uploading {done} of {total}…',
  'vault.uploaded': 'Uploaded {n} photographs.',
  'vault.nag': '{n} of your photographs exist only on this device. Worth keeping a copy.',

  // ---- account ----
  'account.title': 'Account',
  'account.localOnly': 'This copy of BRAW keeps everything in your browser. There is no account server, so nothing you do here leaves this device.',
  'account.signedOutBody': 'An account keeps your quests on more than one device, and lets you order prints of your own photographs.',
  'account.link': 'Create an account',
  'account.linkHint': 'Sign out, then choose “Create account” — your progress will come with you.',
  'account.signedInAs': 'Signed in as {email}',
  'account.syncNow': 'Sync now',
  'account.signOutCloud': 'Sign out of the account',
  'account.synced': 'Your profile is up to date.',
  'account.carriedOver': 'Your existing progress came with you.',
  'account.offlineSignIn': 'Signed in, but your saved quests could not be fetched. They will appear when you have signal.',
  'account.conflict': 'This device and your account have both changed since they last agreed.\n\nThis device: {mine}\nYour account: {theirs}\n\nOK keeps the account version. Cancel keeps this device and sends it up instead.',
  'account.conflictMine': '{trips} quests, {xp} XP',
  'account.conflictTheirs': '{trips} quests, {xp} XP',
  'account.tookRemote': 'Now using the version from your account.',
  'account.keptMine': 'Kept this device, and sent it up.',

  // ---- talking to the server ----
  'cloud.err.offline': 'You are offline. This will go up when you have signal again.',
  'cloud.err.network': 'Could not reach the server.',
  'cloud.err.timeout': 'The server took too long to answer.',
  'cloud.err.rateLimit': 'Too many attempts. Wait a minute, then try again.',
  'cloud.err.badLogin': 'That email and password do not match.',
  'cloud.err.taken': 'There is already an account with that email.',
  'cloud.err.unconfirmed': 'Click the link in your confirmation email first.',
  'cloud.err.passShort': 'Choose a longer password — at least six characters.',
  'cloud.err.badEmail': 'That does not look like an email address.',
  'cloud.err.denied': 'You are signed out, or the session has expired.',
  'cloud.err.server': 'Something went wrong at our end. Try again shortly.',
  'cloud.err.failed': 'That did not work. Try again.',
  'cloud.err.signedOut': 'You are signed out.',
  'cloud.err.offConfig': 'This copy of BRAW has no account server configured.',

  // ---- the shop ----
  'store.title': 'Store',
  'store.sub': 'Turn a journey into something you can put on a wall.',
  'store.notLive': 'The shop is not taking payments yet. You can build an order and we will keep it, but nothing is charged and nothing is posted.',
  'store.make': 'Make one',
  'store.needsPhotos': 'Uses {n} of your photographs',
  'store.priceUnconfirmed': '* Prices shown by the app. The shop confirms them before anything is charged.',
  'store.yourOrders': 'Your orders',
  'store.status.draft': 'Draft',
  'store.status.submitted': 'With the shop',
  'store.status.paid': 'Paid',
  'store.status.fulfilled': 'Posted',
  'store.status.cancelled': 'Cancelled',
  'store.backToShop': 'Back to the shop',
  'store.fromTrip': 'Photographs from',
  'store.allPhotos': 'All my photographs',
  'store.startMonth': 'Starting month',
  'store.slot': 'Photo {n}',
  'store.ready': 'All {n} chosen.',
  'store.stillNeeded': '{n} still to choose.',
  'store.warnPoor': '{n} would print soft at this size. Tap one to swap it.',
  'store.warnFair': '{n} will print acceptably, though not sharply.',
  'store.order': 'Place the order',
  'store.orderNeedsUpload': 'The photographs you choose are uploaded when you order, so the shop can print them.',
  'store.orderNeedsAccount': 'Ordering needs an account, so the shop can be given the photographs.',
  'store.noPhotos': 'No photographs from this journey yet.',
  'store.choosePhoto': 'Choose a photograph',
  'store.clearSlot': 'Leave this one empty',
  'store.uploading': 'Uploading {done} of {total}…',
  'store.placing': 'Placing the order…',
  'store.handedOff': 'Order {ref} — finish paying in the tab that just opened.',
  'store.savedNotLive': 'Your order is saved as {ref}, total {total}.\n\nThe shop is not connected yet, so nothing has been charged and nothing will be posted. Keep the reference — it will still be good when the shop opens.',
  'shop.grade.good': 'Sharp',
  'shop.grade.fair': 'Acceptable',
  'shop.grade.poor': 'Too small to print',
  'common.close': 'Close',
...
const PL = {
  ...
  'data.exported': 'Zapisano {trips} wypraw i {photos} zdjęć.',
  ...
  'data.truncated': 'Ten plik zawiera tylko małe kopie — pełnowymiarowych zdjęć było za dużo, by zmieścić je w jednym. Po oryginały użyj „Zapisz wszystkie zdjęcia na urządzeniu”.',
  'data.photosDropped': 'Nie udało się przywrócić {n} zdjęć — na tym urządzeniu brakuje miejsca.',
  'data.warnCloud': 'Wyczyszczenie danych przeglądarki kasuje wszystko, co nie zostało jeszcze wysłane na konto.',
  'nav.store': 'Sklep',
  'auth.field.email': 'E-mail',
  'auth.field.emailPlaceholder': 'ty@przyklad.pl',
  'auth.forgot': 'Nie pamiętasz hasła?',
  'auth.resetSent': 'Jeśli ten adres ma konto, link do zmiany hasła właśnie jedzie.',
  'auth.confirmSent': 'Sprawdź pocztę i kliknij link, aby dokończyć zakładanie konta.',
  'auth.willCarryOver': 'Twoje obecne postępy przeniosą się na nowe konto.',
  'auth.noteCloud': 'Twoje konto działa na każdym urządzeniu, na którym się zalogujesz. Zdjęcia zostają na Twoim urządzeniu, dopóki ich nie wyślesz.',
  'auth.err.needEmail': 'Najpierw podaj swój adres e-mail.',
  'photo.upload': 'Wyślij kopię',
  'photo.uploaded': 'Skopiowano na Twoje konto',
  'photo.removeConfirm': 'Usunąć to zdjęcie? Jeśli nie ma kopii gdzie indziej, przepadnie na dobre.',
  'photo.failedSpace': 'Na tym urządzeniu nie ma już miejsca na kolejne zdjęcie.',

  // ---- Twoje zdjęcia: gdzie są i jak je zachować ----
  'vault.title': 'Twoje zdjęcia',
  'vault.checking': 'Sprawdzam, gdzie trzymane są Twoje zdjęcia…',
  'vault.none': 'Jeszcze nie ma zdjęć. Zrób jedno na przystanku, a zostanie na tym urządzeniu.',
  'vault.durability.persisted': 'Ta przeglądarka zgodziła się je zachować i nie usunie ich, by zwolnić miejsce.',
  'vault.durability.besteffort': 'Są na tym urządzeniu — ale przeglądarka może je usunąć, gdy zabraknie miejsca.',
  'vault.durability.denied': 'Przeglądarka nie obiecała ich zachować, więc mogą zostać usunięte przy braku miejsca.',
  'vault.durability.none': 'Ta przeglądarka nie potrafi obiecać, że je zachowa.',
  'vault.usage': '{used} z {total} zajęte ({pct}%)',
  'vault.copiedAll': 'Wszystkie {n} mają drugą kopię na Twoim koncie.',
  'vault.copiedSome': '{n} z {total} ma drugą kopię na Twoim koncie.',
  'vault.ios': 'Na iPhonie i iPadzie strona nieotwierana przez dłuższy czas może zostać wyczyszczona. Dodanie BRAW do ekranu początkowego temu zapobiega.',
  'vault.risk.empty': 'Nie ma jeszcze czego stracić.',
  'vault.risk.safe': 'Bezpiecznie — każde zdjęcie istnieje w więcej niż jednym miejscu.',
  'vault.risk.ok': 'Trzymane na tym urządzeniu.',
  'vault.risk.medium': 'Są tylko na tym urządzeniu. Warto mieć kopię gdzie indziej.',
  'vault.risk.high': 'Ryzyko — istnieją wyłącznie tutaj i mogą zostać usunięte bez ostrzeżenia.',
  'vault.saveFiles': 'Zapisz wszystkie zdjęcia na urządzeniu',
  'vault.protect': 'Poproś przeglądarkę, by je zachowała',
  'vault.uploadAll': 'Wyślij {n} na moje konto',
  'vault.note': 'Wyczyszczenie danych przeglądarki kasuje zdjęcia trzymane tylko tutaj. Zapisana kopia albo wysłanie na konto to jedyne, co to przeżyje.',
  'vault.saving': 'Zapisuję {done} z {total}…',
  'vault.saved': 'Zapisano {n} zdjęć.',
  'vault.cancelled': 'Nic nie zostało zapisane.',
  'vault.saveFailed': 'Nie udało się zapisać zdjęć.',
  'vault.protected': 'Przeglądarka zachowa Twoje zdjęcia.',
  'vault.protectRefused': 'Przeglądarka jeszcze nie obiecała. Użyj BRAW jeszcze kilka razy albo dodaj go do ekranu początkowego i spóbuj ponownie.',
  'vault.uploading': 'Wysyłam {done} z {total}…',
  'vault.uploaded': 'Wysłano {n} zdjęć.',
  'vault.nag': '{n} Twoich zdjęć istnieje tylko na tym urządzeniu. Warto zrobić kopię.',

  // ---- konto ----
  'account.title': 'Konto',
  'account.localOnly': 'Ta wersja BRAW trzyma wszystko w Twojej przeglądarce. Nie ma serwera kont, więc nic stąd nie opuszcza tego urządzenia.',
  'account.signedOutBody': 'Konto pozwala mieć wyprawy na kilku urządzeniach i zamówić odbitki własnych zdjęć.',
  'account.link': 'Załóż konto',
  'account.linkHint': 'Wyloguj się, a potem wybierz „Załóż konto” — postawy pójdą razem z Tobą.',
  'account.signedInAs': 'Zalogowano jako {email}',
  'account.syncNow': 'Synchronizuj teraz',
  'account.signOutCloud': 'Wyloguj się z konta',
  'account.synced': 'Twój profil jest aktualny.',
  'account.carriedOver': 'Dotychczasowe postępy poszły razem z Tobą.',
  'account.offlineSignIn': 'Zalogowano, ale nie udało się pobrać zapisanych wypraw. Pojawią się, gdy będzie zasięg.',
  'account.conflict': 'To urządzenie i Twoje konto zmieniły się od ostatniej zgodności.\n\nTo urządzenie: {mine}\nTwoje konto: {theirs}\n\nOK zachowa wersję z konta. Anuluj zachowa to urządzenie i wyśle je na serwer.',
  'account.conflictMine': '{trips} wypraw, {xp} PD',
  'account.conflictTheirs': '{trips} wypraw, {xp} PD',
  'account.tookRemote': 'Używam teraz wersji z Twojego konta.',
  'account.keptMine': 'Zachowano to urządzenie i wysłano je na serwer.',

  // ---- rozmowa z serwerem ----
  'cloud.err.offline': 'Jesteś offline. To pojedzie na serwer, gdy wróci zasięg.',
  'cloud.err.network': 'Nie udało się połączyć z serwerem.',
  'cloud.err.timeout': 'Serwer odpowiadał zbyt długo.',
  'cloud.err.rateLimit': 'Zbyt wiele prób. Odczekaj minutę i spróbuj ponownie.',
  'cloud.err.badLogin': 'Ten e-mail i hasło do siebie nie pasują.',
  'cloud.err.taken': 'Konto z tym adresem już istnieje.',
  'cloud.err.unconfirmed': 'Najpierw kliknij link w e-mailu potwierdzającym.',
  'cloud.err.passShort': 'Wybierz dłuższe hasło — co najmniej sześć znaków.',
  'cloud.err.badEmail': 'To nie wygląda na adres e-mail.',
  'cloud.err.denied': 'Jesteś wylogowany albo sesja wygasła.',
  'cloud.err.server': 'Coś poszło nie tak po naszej stronie. Spróbuj za chwilę.',
  'cloud.err.failed': 'Nie udało się. Spróbuj ponownie.',
  'cloud.err.signedOut': 'Jesteś wylogowany.',
  'cloud.err.offConfig': 'Ta wersja BRAW nie ma skonfigurowanego serwera kont.',

  // ---- sklep ----
  'store.title': 'Sklep',
  'store.sub': 'Zamień wyprawę w coś, co powiesisz na ścianie.',
  'store.notLive': 'Sklep jeszcze nie przyjmuje płatności. Możesz złożyć zamówienie i je zachowamy, ale nic nie zostanie pobrane ani wysłane.',
  'store.make': 'Zrób jeden',
  'store.needsPhotos': 'Wykorzystuje {n} Twoich zdjęć',
  'store.priceUnconfirmed': '* Ceny pokazywane przez aplikację. Sklep potwierdza je, zanim cokolwiek zostanie pobrane.',
  'store.yourOrders': 'Twoje zamówienia',
  'store.status.draft': 'Szkic',
  'store.status.submitted': 'U sklepu',
  'store.status.paid': 'Opłacone',
  'store.status.fulfilled': 'Wysłane',
  'store.status.cancelled': 'Anulowane',
  'store.backToShop': 'Wróć do sklepu',
  'store.fromTrip': 'Zdjęcia z',
  'store.allPhotos': 'Wszystkie moje zdjęcia',
  'store.startMonth': 'Miesiąc początkowy',
  'store.slot': 'Zdjęcie {n}',
  'store.ready': 'Wybrano wszystkie {n}.',
  'store.stillNeeded': 'Zostało do wyboru: {n}.',
  'store.warnPoor': '{n} wydrukuje się nieostro w tym rozmiarze. Dotknij, aby podmienić.',
  'store.warnFair': '{n} wydrukuje się przyzwoicie, choć nie całkiem ostro.',
  'store.order': 'Złóż zamówienie',
  'store.orderNeedsUpload': 'Wybrane zdjęcia zostaną wysłane przy zamówieniu, żeby sklep mógł je wydrukować.',
  'store.orderNeedsAccount': 'Do zamówienia potrzebne jest konto, żeby sklep mógł dostać zdjęcia.',
  'store.noPhotos': 'Z tej wyprawy nie ma jeszcze zdjęć.',
  'store.choosePhoto': 'Wybierz zdjęcie',
  'store.clearSlot': 'Zostaw to miejsce puste',
  'store.uploading': 'Wysyłam {done} z {total}…',
  'store.placing': 'Składam zamówienie…',
  'store.handedOff': 'Zamówienie {ref} — dokończ płatność w karcie, która się właśnie otworzyła.',
  'store.savedNotLive': 'Twoje zamówienie zapisano jako {ref}, na kwotę {total}.\n\nSklep nie jest jeszcze podłączony, więc nic nie zostało pobrane i nic nie zostanie wysłane. Zachowaj numer — będzie ważny, gdy sklep ruszy.',
  'shop.grade.good': 'Ostre',
  'shop.grade.fair': 'Przyzwoite',
  'shop.grade.poor': 'Za małe do druku',
