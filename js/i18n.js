...
const EN = {
  ...
  'geo.found': 'Found you — accurate to about {n} m',
  'geo.searching': 'Looking for you…',
  'geo.notHere': 'You are about {km} km from Scotland, so there is nowhere on this map to put you. Your location will show when you arrive.',
  'geo.failed': 'No location came back. Check that location is switched on for your browser, then try again — outdoors works best.',
...
const PL = {
  ...
  'geo.found': 'Znaleziono Cię — dokładność około {n} m',
  'geo.searching': 'Szukam Cię…',
  'geo.notHere': 'Jesteś około {km} km od Szkocji, więc nie ma Cię gdzie umieścić na tej mapie. Twoja lokalizacja pojawi się po przyjeździe.',
  'geo.failed': 'Nie otrzymano lokalizacji. Sprawdź, czy lokalizacja jest włączona dla przeglądarki, i spróbuj ponownie — najlepiej na zewnątrz.',
